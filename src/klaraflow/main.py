...
# --- NEW: Company Settings Routes ---
app.include_router(department_router.router, prefix="/api/v1/settings/departments", tags=["Departments"])
app.include_router(designation_router.router, prefix="/api/v1/settings/designations", tags=["Designations"])
